...
pytesseract.pytesseract.tesseract_cmd = r'/home/florin/Tesseract-OCR/tesseract.py' #Deschidem tesseract

# img = cv2.imread(filename) #Poza pe care o alegem
img = cv2.imread(r'/home/florin/Downloads/metode de programare/Lab6/numar inmatriculare.png')
